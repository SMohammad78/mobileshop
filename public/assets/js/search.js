...
function renderSearch(_product, _filters) {
  var filteredSearch = _product.filter(function (item) {
  ...
  var result = "";
  filteredSearch.forEach(function (item) {
    result += "<div class=\"w-full absolute p-2 shadow-md bg-white rounded-xl\n        top-8 left-0 z-10 hidden group-hover:block transition-all\">\n        <a href=\"/single_product.html?id=".concat(item.id, "\" class=\"flex items-center justify-start gap-6 mt-4\">\n            <div class=\"w-24 h-auto\">\n                <img src=").concat(item.imgURL, " alt=\"\" class=\"rounded-xl w-full h-auto\">\n            </div>\n\n            <div class=\"flex flex-col justify-evenly gap-3\">\n                <p class=\"text-slate-800\"> ").concat(item.title, " </p>\n                <p class=\"text-slate-700 text-sm\"> ").concat(item.price, " </p>\n            </div>\n        </a>\n    </div>");
  });
  resultSearch.innerHTML = result;
}
document.addEventListener("DOMContentLoaded", function () {
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('/sample/api/products.php').then(function (response) {
